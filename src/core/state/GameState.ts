...
export type Zone = 'entrance' | 'slots' | 'poker' | 'bar' | 'blackjack' | 'roulette' | 'plinko' | 'bingo' | 'floor';
export type InteractionState = 'free' | 'slots' | 'poker' | 'bar' | 'blackjack' | 'roulette' | 'plinko' | 'bingo';
